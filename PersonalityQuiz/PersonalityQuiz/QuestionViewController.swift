...
class QuestionViewController: UIViewController {
    ...
    @IBAction func multiSubmitAnswer(_ sender: UIButton) {
        nextQuestion()
    }
    ...
    @IBAction func rangedSubmitAnswer(_ sender: UIButton) {
        nextQuestion()
    }
    func nextQuestion() {
        questionIndex += 1
    ...
    func updateSingleStack(using answers: [Answer]) {
        ...
        questionProgessView.progress = Float(questionIndex) / Float(questions.count)
    }
