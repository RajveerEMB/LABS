...
class EmojiTableViewController: UITableViewController {
    ...
    @IBSegueAction func addEditEmoji(_ coder: NSCoder, sender: Any?) -> AddEditTableViewController? {
        ...
        guard let indexpath = sender as? IndexPath else { return  AddEditTableViewController(coder: coder, emoji: nil) }
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, moveRowAt fromIndexPath: IndexPath, to: IndexPath) {
        ...
        let temp = emojis.remove(at: fromIndexPath.row)
        emojis.insert(temp, at: to.row)
        Emoji.saveToFile(emojis: emojis)
    ...
    @IBAction func unwindToEmojiTVC(segue: UIStoryboardSegue) {
        ...
        guard segue.identifier == "save", let addEditTVC = segue.source as? AddEditTableViewController, let emoji = addEditTVC.emoji else { return }
