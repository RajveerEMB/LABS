...
if let meal1 = getMealLog("Breakfast") {
    print(meal1)
}

if let meal2 = getMealLog("Lunch") {
    print(meal2)
}
/*:
 ...
 */
var mealLog: [String: Meal] = ["mealLog": Meal(food: ["Bagel", "Orange Juice", "Egg Whites"], calories: 530)]
...
if let savedMealLog = checkMealLogSaved() {
    print(savedMealLog)
}
/*:
