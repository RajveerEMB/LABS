...
var yourName = User(name: "Rajveer", age: 21, height: 180.0, weight: 75.0, activityLevel: 8)
print("Name: \(yourName.name), Age: \(yourName.age), Height: \(yourName.height), Weight: \(yourName.weight), Activity Level: \(yourName.activityLevel)")
