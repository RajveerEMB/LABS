...
let walkingChallenges = ["Walk 3 miles a day", "Walk 10,000 steps daily", "Walk for 30 minutes every morning"]
let runningChallenges = ["Run 5 times a week", "Complete a 5K race", "Run 2 miles in under 20 minutes"]
let weightliftingChallenges = ["Lift weights 3 times a week", "Bench press 200 pounds"]
...
let challenges = [walkingChallenges, runningChallenges, weightliftingChallenges]
...
if committedChallenges.isEmpty {
    print("Please commit to a challenge to get started!")
