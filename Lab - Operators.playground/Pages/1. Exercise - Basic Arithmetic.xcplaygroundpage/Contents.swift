...
let addition=width+width+height+height
print(addition)
...
print("The result of divinsion is =")
...
let doubke3 : Double=3
let divisionResult=double10/doubke3
print(divisionResult)
print("This will give a decimal value whereas integer will give only integer value")
...
let even : Int = 10
let odd : Int = 9
print("The remainder of even is \(even%2)")
print("The remainder of odd is \(odd%2)")
/*:
