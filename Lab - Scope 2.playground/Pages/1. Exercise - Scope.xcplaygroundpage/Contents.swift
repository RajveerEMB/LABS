...
//print("The value of foo is \(foo)")
print("The code will generate a compiler error because foo is defined in a function as local variable and is only accessible within that function scope, not the print statement")
...
print("Both staments compile because x is defined as a global variable and is accessible from both the for loop and the print statement. foo is defined as a local variable within the for loop and is only accessible within that loop.")
